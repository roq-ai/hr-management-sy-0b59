  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empowering your workforce with HR Management System - Streamlining employee data, payrolls, time tracking, vacations, and performance evaluations in one central hub."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empowering your workforce with HR Management System - Streamlining employee data, payrolls, time tracking, vacations, and performance evaluations in one central hub.`}
            </Text>
            <Box
